...
`;
  ...
  console.log('\n📄 SQL 脚本已准备好');
  console.log('\n' + '='.repeat(80));
  console.log('由于 Supabase REST API 限制，无法通过程序直接执行 DDL 语句。');
  console.log('请按照以下步骤手动执行：');
  console.log('='.repeat(80));
  console.log('\n1. 在浏览器中打开: http://10.1.20.75:8000');
  console.log('2. 登录 Supabase Studio');
  console.log('3. 在左侧菜单中找到 "SQL Editor" 或 "SQL"');
  console.log('4. 将下面的 SQL 复制到编辑器中');
  console.log('5. 点击 "Run" 或 "Execute" 按钮执行');
  console.log('\n' + '='.repeat(80));
  console.log('SQL 脚本:');
  console.log('='.repeat(80));
  console.log(sql);
